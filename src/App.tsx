...
import {authMeTC} from "./n1-main/m2-BLL/Login-reducer";
import {Packs} from "./n1-main/m1-UI/NavBar(left)/04-Packs/Packs";
import {AppStateType} from "./n1-main/m2-BLL/00-store";
        ...
        <div className="App">
            ...
            <div style={{margin: '40px'}}>
                <Switch>
                    ...
                    <Route exact path={RoutePath.PASSWORD_RECOVERY}
                           render={() => <TableMenu children={<PasswordRecovery/>}/>}/>
                    <Route path={RoutePath.NEW_PASSWORD + '/:token'}
                           render={() => <TableMenu children={<NewPassword/>}/>}/>
